...
i18n.translations = {
  ...
  bg: {
    ...
    sunday_school_classes: 'Часове в неделното училище за всички възрастови групи',
    childrens_church: 'Детска църква по време на богослужения',
    vacation_bible_school: 'Ваканционно библейско училище',
    kids_camps: 'Детски лагери и отдих',
    family_ministry_events: 'Семейни служебни събития',
    teaching_approach: 'Подход на преподаване',
    teaching_approach_desc: 'Използваме творчески, интерактивни методи, за да помогнем на децата да:',
    learn_bible_stories: 'Научат библейски истории и принципи',
    develop_prayer_habits: 'Развият молитвени навици',
    understand_gods_love: 'Разберат Божията любов',
    build_christian_friendships: 'Изградят християнски приятелства',
    serve_community: 'Служат на другите в тяхната общност',
    ...
    monthly_sponsorship_provides: 'Чрез месечно спонсориране, поддръжниците предоставят:',
    educational_expenses: 'Образователни разходи, включително такси, книги и материали',
    nutritious_meals: 'Питателни ястия и здравеопазване',
    clothing_necessities: 'Облекло и други основни нужди',
    spiritual_guidance: 'Духовно ръководство и библейско наставление',
    hope_future: 'Надежда за по-светло бъдеще',
    ...
    global_impact_desc: 'Фондът за едно дете работи в множество държави, партнирайки с местни конгрегации на Църква на Бога на Пророчеството за идентифициране и подкрепа на деца, които се нуждаят от образователна помощ.',

    // About section content
    global_movement_desc: 'Църква на Бога на Пророчеството е живо, глобално християнско движение с присъствие в 135 държави и територии. Обединени сме от нашата обща вяра в Исус Христос и нашия ангажимент към библейската истина.',
    our_vision: 'Нашата визия',
    our_vision_text: 'Да бъдем водена от Духа глобална общност от вярващи, ангажирани с достигането на всеки човек във всяка нация с Евангелието на Исус Христос.',
    our_values: 'Нашите ценности',
    biblical_authority: 'Библейски авторитет',
    biblical_authority_desc: 'Вярваме, че Библията е вдъхновената Божия дума',
    global_unity: 'Глобално единство',
    global_unity_desc: 'Ние сме една църква с много изрази',
    spirit_led_living: 'Водено от Духа живеене',
    spirit_led_living_desc: 'Разчитаме на Светия Дух за ръководство',
    holistic_ministry: 'Холистично служение',
    holistic_ministry_desc: 'Служим на целия човек',
    cultural_sensitivity: 'Културна чувствителност',
    cultural_sensitivity_desc: 'Уважаваме и приемаме разнообразието',

    // Who We Are content
    global_movement: 'Глобално движение',
    our_identity: 'Нашата идентичност',
    we_are: 'Ние сме:',
    our_story: 'Нашата история',

    // What We Believe content
    we_believe_in: 'Вярваме в:',
    trinity_desc: 'Един Бог, съществуващ вечно в три лица: Отец, Син и Свети Дух.',
    jesus_desc: 'Божествеността на Исус Христос, Неговото девствено раждане, безгрешен живот, изкупителна смърт, телесно възкресение и славно завръщане.',
    salvation_desc: 'Спасение чрез благодат чрез вяра в Исус Христос, не чрез дела.',
    holy_spirit_desc: 'Кръщението със Светия Дух като отделно преживяване, достъпно за всички вярващи.',
    church_desc: 'Църта като тяло на Христос, призвана към единство и светост.',
    scripture_desc: 'Библията като вдъхновената, безгрешна Божия дума и нашия окончателен авторитет за вяра и практика.',
    ...
    events_description: 'Присъединете се към нас за тези специални събирания и конференции през годината.',
    ...
    view_full_calendar: 'Вижте пълния календар',
