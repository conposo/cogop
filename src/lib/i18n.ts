...
i18n.translations = {
  en: {
    ...
    contact_form_error_message: 'There was an error sending your message. Please try again.',
    ...
    church_not_found_message: 'The requested church could not be found.',
    back_to_churches: 'Back to Churches',
    loading_church_details: 'Loading church details...',
    back_to_all_churches: 'Back to All Churches',
    about_us: 'About Us',
    ...
    join_church_participate_discussions: 'Join this church to participate in community discussions',
    contact_church_admin_access: 'Contact a church administrator for access',
    ...
    as_a_role_you_can_create_participate: 'As a {role}, you can create and participate in discussions',
    just_now: 'Just now',
    h_ago: 'h ago',
    d_ago: 'd ago',
    ...
    // Additional Find a Church strings
    view_details: 'View Details',
    try_again: 'Try Again',
    
    // Churches page additional strings
    view_details_btn: 'View Details',
    call_btn: 'Call',
    email_btn: 'Email',
    website_btn: 'Website',
    ...
    // Discussion Card strings
    pinned_discussion: 'Pinned Discussion',
    confirm_delete_discussion: 'Are you sure you want to delete this discussion? This action cannot be undone.',
    error_updating_discussion: 'Error updating discussion. Please try again.',
    error_deleting_discussion: 'Error deleting discussion. Please try again.',
    pin_discussion: 'Pin Discussion',
    unpin_discussion: 'Unpin Discussion',
    ...
    minutes_ago: '{minutes} minute{plural} ago',
    hours_ago: '{hours} hour{plural} ago',
    days_ago: '{days} day{plural} ago',
    updated: 'Updated',
  },
  bg: {
    // Navigation
    ...
    // Church Details Page
    church_not_found: 'Църквата не е намерена',
    church_not_found_message: 'Търсената църква не може да бъде намерена.',
    back_to_churches: 'Обратно към църквите',
    loading_church_details: 'Зареждане на подробностите за църквата...',
    back_to_all_churches: 'Обратно към всички църкви',
    about_us: 'За нас',
    service_times: 'Времена на службите',
    programs_ministries: 'Програми и служения',
    ...
    pastor: 'Пастор',
    city: 'Град',
    join_discussions: 'Присъедини се към дискусиите',
    call_church: 'Позвъни на църквата',
    send_email: 'Изпрати имейл',
    visit_website: 'Посети уебсайта',
    get_directions: 'Вземи указания',
    location: 'Местоположение',
    view_on_map: 'Виж на картата',
    quick_contact: 'Бърз контакт',
    church_information: 'Информация за църквата',
    united_states: 'Съединени щати',
    
    // Community Discussions
    community_discussions: 'Обществени дискусии',
    join_church_participate_discussions: 'Присъединете се към тази църква, за да участвате в обществените дискусии',
    contact_church_admin_access: 'Свържете се с администратор на църквата за достъп',
    no_discussions_yet: 'Все още няма дискусии',
    total: 'Общо',
    this_week: 'Тази седмица',
    comments: 'Коментари',
    recent_activity: 'Скорошна активност',
    by: 'от',
    most_active: 'Най-активна',
    as_a_role_you_can_create_participate: 'Като {role}, можете да създавате и участвате в дискусии',
    just_now: 'Току-що',
    h_ago: 'ч назад',
    d_ago: 'д назад',
    ...
    search_church_placeholder: 'Търсете по име на църква, град, пастор или...',
    ...
    // Additional Find a Church strings - Bulgarian
    view_details: 'Виж подробности',
    try_again: 'Опитайте отново',
    
    // Churches page additional strings - Bulgarian
    view_details_btn: 'Виж подробности',
    call_btn: 'Обади се',
    email_btn: 'Имейл',
    website_btn: 'Уебсайт',
    ...
    // Discussion Card strings - Bulgarian
    pinned_discussion: 'Закачена дискусия',
    confirm_delete_discussion: 'Сигурни ли сте, че искате да изтриете тази дискусия? Това действие не може да бъде отменено.',
    error_updating_discussion: 'Грешка при актуализирането на дискусията. Моля, опитайте отново.',
    error_deleting_discussion: 'Грешка при изтриването на дискусията. Моля, опитайте отново.',
    pin_discussion: 'Закачи дискусия',
    unpin_discussion: 'Откачи дискусия',
    edit_discussion: 'Редактирай дискусия',
    delete_discussion: 'Изтрий дискусия',
    read_more: 'Прочети повече',
    join_discussion: 'Присъедини се към дискусията',
    last_activity: 'Последна активност:',
    comments_count: '{count} коментар{plural}',
    minutes_ago: 'преди {minutes} минут{plural}',
    hours_ago: 'преди {hours} час{plural}',
    days_ago: 'преди {days} ден{plural}',
    updated: 'Актуализирано',

    // Calendar Page - Bulgarian
    ...
    send_message: 'Изпрати съобщение',
    sending: 'Изпращане...',
    contact_form_success_message: 'Благодарим ви за съобщението. Ще се свържем с вас скоро!',
    contact_form_error_message: 'Възникна грешка при изпращането на съобщението. Моля, опитайте отново.',
  },
};
