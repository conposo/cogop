...
export const bgMessages = {
    ...
    who_we_are_html: `
        <h2>Въведение</h2>
        <p>Божия църква на пророчеството е динамично християнско движение, основано на Писанието, твърдо във вярата и целеустремено към хората. Това е световна общност от вярващи, обединени в поклонение, работещи ръка за ръка, за да споделят Божията любов и послание на надежда с разбитите сърца.</p>
        <p>Влиянието на Божия църква на пророчеството достига далеч. Смята се, че на всеки 24 часа по целия свят 300 души получават спасение, близо 100 души се кръщават във вода и над 14 000 проповедници активно провъзгласяват Евангелието. Всеки ден поне една нова църква отваря врати, за да докосне местната общност чрез усилията на това движение.</p>
        <p>Църквата е етнически и културно разнообразна, като 90% от нейните членове живеят извън Северна Америка. В момента Църквата служи в 133 страни, като всеки месец над 1400 души стават членове. По приблизителни оценки 14 000 мъже и жени в момента имат лиценз да служат и да проповядват Евангелието.</p>
        <p>Божия църква на пророчеството ви кани да се присъедините към нас, докато се стремим да изпълним Божията мисия да помирим света с Христос чрез силата на Святия Дух.</p>

        <h2>Нашето видение</h2>
        <p>Помиряване на света с Христос чрез силата на Святия Дух.</p>

        <h2>Нашата мисия</h2>
        <p>Божия църква на пророчеството е прославяне на Христос, святост, изпълване с Духа, правене на ученици от всички народи, основаване на църкви със силен копнеж за християнско единство.</p>

        <h2>Нашите основни ценности</h2>
        <p>Нашата мисия произтича пряко от основните ни ценности и ги утвърждава. Основните ценности на Божия църква на пророчеството са:</p>
        <ul>
          <li>Молитва</li>
          <li>Жътвата</li>
          <li>Развитие на лидерски умения</li>
          <li>Библейско настойничество</li>
          <li>Служене</li>
        </ul>

        <h2>Елементи на мисията</h2>
        <p><strong>Прославяне на Христос</strong> – във всичко, което правим, да се вижда Исус Христос. Той е Главата на Тялото и затова трябва да бъде прославен във всичко. Потвърждаваме желанието си Христос да се вижда по-съвършено чрез това духовно семейство.</p>
        <p><strong>Святи хора</strong> – тази църква беше част от „движението на светостта” преди да стане петдесятническа. Ние се родихме от съживителното Движение на светостта в Северна Америка. Призивът към святост е дълбоко вкоренен и е част от нашата съдба. Ние подновяваме нашето посвещение към Божията благодат и очистването чрез Неговата кръв, за да можем да бъдем като Него.</p>
        <p><strong>Изпълнени с Духа</strong> – пророческото обещание на Бог, че „в последните дни Той ще излее Духа Си над цялата земя”, е било и продължава да бъде централна част от ДНК-то на това глобално семейство – Божия църква на пророчеството. Ние декларираме нашата пълна зависимост от Святия Дух, Който е даден, за да води и да дава сила на Църквата.</p>
        <p><strong>Всички народи</strong> – по Божия замисъл това международно служение от самото си начало се е придържало към идеала, че Църквата на Бога ще се състои от всички „племена, езици и народи”. Ние, доколкото ни позволяват ограничените ни възможности, се опитахме да оформим тази Църква по тези контурни линии, дори преди мултикултурността да бъде приемлива. Ние празнуваме разнообразието на всяко ниво на лидерство в тази международна организация и се ангажираме да продължим това богато наследство.</p>
        <p><strong>Създаване на ученици</strong> – през повече от век на служение тази семейна мрежа е била посветена на библейското призвание да създава ученици в съответствие с Великото поръчение. Разбираме, че силата на създаването на ученици ще определи нашата сила в евангелизирането.</p>
        <p><strong>Движение за основаване на църкви</strong> – здравите църкви, които основават нови църкви, допринасят значително за разпространението на Евангелието по целия свят. Това служение е отразявало този идеал последователно в практиката през цялото си съществуване. Нашата цел е да удвоим усилията си да инвестираме в основаването на църкви на всяко място, където имаме възможност.</p>
        <p><strong>Християнски съюз</strong> – нашите предци вярваха, че може да има единство по-голямо от религиозните вероизповедания на днешния ден, което Бог ще използва, за да прослави Своето име на земята. Ние възнамеряваме да сътрудничим на всички, които възвисяват името на Христос и Неговото велико Евангелие.</p>
      `,
