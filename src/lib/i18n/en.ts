...
export const enMessages = {
    ...
    hero_btn_1: 'See more',
    booklet_download_pdf: 'Download PDF',
    ...
    /** Full statement HTML for locales that ship it; empty keeps the short summary layout in ContentContext. */
    ...
    leadership_organization_html: `
        ...
        <p>The organizational structure of the Church of God of Prophecy exists and operates at three interdependent levels: international, national/regional/state, and local.</p>
        <p>The international level of church organization operates on a worldwide basis and provides a global network of support and interaction for church ministries in all 50 US states and in more than 130 countries.</p>
        <p>The national/regional/state level provides more focused leadership and support directly in the context of the countries and states where the Church serves. The local level is the heart of the Church. At this level caring communities are formed in thousands of towns and settlements around the world where the Church’s mission is carried out daily. These local groups of believers form the framework in which the Church fulfills its primary mission to reconcile the world to Christ through the power of the Holy Spirit.</p>
        <p>At every level of organization in the Church, effort is invested in dynamic and flexible life to avoid stagnation. In increasingly complex and constantly changing societies, we are aware that our ability to remain relevant to people’s needs depends on how adequately we respond to social change without compromising truth. We acknowledge that our God is dynamic, not static; He is God who moves and acts in the affairs of humanity. We are resolved to be a pilgrim people who move when He moves and stop when He stops. In this way the organizational structures described below currently serve our mission but are subject to review and revision according to the leading of the Holy Spirit.</p>

        <h2>International Level</h2>
        <p>The International Assembly, open to all members, is the highest decision-making body in the Church of God of Prophecy. It is currently convened every two years. The Presiding Bishop, in consultation with the Church’s chief elders, sets and moderates the assembly program.</p>
        <p>During discussion of doctrinal and business matters, each elder has an equal voice. Doctrinal decisions are made unanimously; business decisions by a prevailing majority. The assembly also provides time for inspiring worship, preaching, teaching, and fellowship.</p>
        <p>During the assembly the Presiding Bishop presents his vision for the direction in which he believes God is leading the Church.</p>
        <p>At the international level of organization, the Presiding Bishop is elected by unanimous decision of the International Convention for a six-year term. Together with the chief elders, who are elected by the International Elders Council, he carries a broad range of spiritual and administrative leadership responsibilities. The Presiding Bishop and chief elders make the final selection of all international leaders, including national/regional/state bishops, leaders of international ministries, and the standing committees of the Assembly. They also continually seek God for spiritual leadership and articulate the vision for the Church’s worldwide ministries.</p>
        <p>The International Elders Council consists of all national/regional/state bishops and bishops who serve in international ministries.</p>
        <p>Licensing and discipline of ministers are in the hands of the International Elders Council.</p>
        <p>The principle of New Testament leadership was adopted in 1994 by the International Assembly. Plural leadership extends worldwide through seven chief elders serving in different geographical regions of the world. According to the gifts God has given them, they are chosen by the International Elders Council to give guidance to the worldwide Church of God of Prophecy in fulfilling its mission. They work directly with the Presiding Bishop to provide shared leadership in carrying out the functions of this ministry at the global level.</p>
        <p>The international offices of the Church of God of Prophecy seek to encourage inspiring leadership and to provide substantial support that greatly increases the Church’s evangelistic witness and advances its mission. The Presiding Bishop selects executive directors of the international office ministries in consultation with the chief elders. Ministry leaders are chosen by the respective chief bishop and work together to fulfill the worldwide mission of the ministry given by God’s Church.</p>

        <h2>National/Regional/State Level</h2>
        <p>National/regional/state bishops are chosen by the respective chief elder, and each functions as the presiding bishop of his or her territory.</p>
        <p>Each national/regional/state bishop is responsible to select, prepare, and appoint administrative staff as well as a pastor for each local church in his or her area. The national/regional/state bishop plans and moderates periodic assemblies in and for his or her specific territory. The gatherings are open to all members and include time for praise and worship, fellowship, and business. They also give the bishop opportunity to give direction for the many preaching programs conducted across his or her area.</p>

        <h2>Local Level</h2>
        <p>The great commission Christ gave the Church is fulfilled most directly through the various local ministries. The local church is where people turn to Christ, are baptized, received into church fellowship, and trained in victorious Christian living. The pastor, in consultation with the local church, is appointed by the area bishop and serves as spiritual and administrative leader. While praying and seeking God’s guidance for shepherding the flock and sharing the Gospel with the local community, he or she selects and prepares numerous lay leaders to share in these efforts.</p>
        <p>Typically the local church offers specific ministries for the spiritual development of children, youth, women, and men. The Church of God of Prophecy recognizes the unique needs of its members and the urgency of nurturing them to full maturity in Christ.</p>
        <p>Each local church should hold a conference every three months to inform members and make spiritual and business decisions. The conference may also exercise church discipline in matters involving unruly members; however, this must always be done with one aim—the restoration and reconciliation of the brother or sister who has fallen.</p>
        <p>All adult members in the local church have an equal voice on matters brought before the local conference.</p>
      `,
    
    our_history_title: 'Our History',
    our_history_description: 'Journey through the rich history of the Church of God of Prophecy.',
    /** Full narrative HTML; empty falls back to placeholder in ContentContext. */
    our_history_html: `
        <p>From its beginning, the Church of God of Prophecy has drawn together people with a deep thirst for God. It drives them beyond ordinary Christian relationships into fellowship with believers devoted to the teachings of the whole Bible.</p>
        <p>In August 1886 Richard Spurling (1810–1891), an ordained Baptist minister, and his youngest son, R. G. Spurling, reacted against the prevailing creedalism among many Baptists of that day. Landmarkism had spread among Baptist churches in the southern United States with a view of the Church that the Spurlings rejected. As a result, Richard Spurling and seven like-minded associates withdrew from the Baptist missionary churches at Holly Springs and Pleasant Hill in Monroe County, Tennessee, and Cherokee County, North Carolina, and organized what they regarded as a true restoration of the apostolic church.</p>
        <p>They called it the “Christian Union.” The group resolved to free itself “from all (human) creeds and traditions… to take the New Testament, or law of Christ, as their only rule of faith and practice, giving each other equal rights and privileges to read and interpret for themselves as led by conscience,” and to “meet together as the Church of God to transact business…” In September of that year Spurling ordained his son Richard Green as pastor with the assembly’s consent. In 1891 the elder Spurling died, leaving the younger man alone to carry forward his father’s vision for the Christian Union.</p>
        <p>Richard Green Spurling (1857–1935) succeeded in forming at least two more Christian Union congregations, though the original one at Barney Creek in Monroe County ceased to function. Some of the founders of the first congregation helped establish the next two, so the original organization was continued.</p>
        <p>In 1895 parts of western North and South Carolina, north Georgia, and southeastern Tennessee were stirred by the radical wing of the holiness movement. Benjamin Hardin Irwin came south from the Midwest and exerted great influence in the region with his “baptism with fire” message. Spurling’s churches were drawn into the movement, moving away from typical Baptist characteristics and toward holiness doctrines. R. G. Spurling embraced holiness but tried to temper the fanaticism characteristic of Irwin’s movement. Those who experienced “fire baptism” were often difficult to manage, and Spurling struggled to maintain control of his followers.</p>
        <p>In the summer of 1896 in Cherokee County, North Carolina, about twelve miles from Spurling’s churches in Monroe and Polk Counties, Tennessee, a revival influenced by Irwin broke out. During meetings held at the Shearer schoolhouse, some 130 people received the baptism of the Holy Spirit and spoke in unknown tongues. Key leaders included William Martin, a Methodist; Joseph M. Tipton; Milton McNabb; and Billy Hamby—all Baptists. Each of these men knew Spurling and had been influenced by him.</p>
        <p>W. F. Bryant, a Baptist preacher, joined the holiness movement during this Cherokee County revival. He eventually became leader of the group in the Camp Creek area of North Carolina. Severe persecution followed Bryant’s group in the following years. Baptist churches in the region expelled everyone who “advocated the modern doctrine of sanctification,” labeling it “dangerous heresy.” Persecution, sometimes violent, continued as opponents of holiness took advantage of Bryant’s loosely organized community. Outside pressure combined with internal lack of order and discipline nearly destroyed Bryant’s group. By 1902 the small fellowship had shrunk to no more than twenty people.</p>
        <p>Had it not been for the wise counsel and influence of R. G. Spurling, Bryant and his believers might have vanished from history. But on May 15, 1902, Spurling persuaded Bryant to reorganize so the work could continue. Out of that came the Holiness Church at Camp Creek. Spurling was chosen pastor by the church, and Bryant was ordained deacon—thus Spurling’s vision of restoring God’s church was preserved.</p>
        <p>The next year a dynamic, cheerful new leader was drawn from the Holiness Church at Camp Creek: A. J. Tomlinson. Tomlinson (1865–1943), a Quaker, had experienced salvation in his personal life and came to Appalachia in 1899 as a missionary under the American Bible Society. He befriended Spurling, Bryant, and the Holiness Church at Camp Creek. Elder Spurling made a deep impression on Tomlinson when he explained his vision of the Church.</p>
        <p>On June 13, 1903, after a period of agonizing struggle and personal revelation from God, Tomlinson united with the group. Spurling gave him the right hand of fellowship, which Tomlinson received understanding it to be God’s true biblical Church. The moment remained sacred to Tomlinson for the rest of his life. After years of religious wandering, he had finally found his place to labor for God.</p>
        <p>Tomlinson’s leadership gifts were quickly recognized by Spurling and the others, and he was immediately chosen pastor of the Camp Creek assembly. The former Quaker was now driven by a sense of mission as never before. Under his vigorous leadership the Church soon planted several congregations in North Carolina, Tennessee, and Georgia, and over the next twenty years membership grew to more than twenty thousand, concentrated mainly in the southern United States.</p>
        <p>By 1906 the need had arisen for an annual gathering to encourage closer unity and fellowship among the churches. The first was held January 26–27 at J. C. Murphy’s home in Cherokee County, North Carolina. At the next gathering in 1907 the name Church of God was officially adopted. At the 1909 assembly A. J. Tomlinson was elected general overseer of the entire Church of God, a role he held until his death.</p>
        <p>Like many others at Camp Creek, Tomlinson leaned toward Pentecostal teaching even before the twentieth century. Yet it was only after the outpouring of the Holy Spirit at Charles F. Parham’s Bethel Bible School in Topeka, Kansas, in 1901 and the Azusa Street revival in Los Angeles led by W. J. Seymour, beginning in 1906, that the Church of God fully embraced the Pentecostal movement.</p>
        <p>On January 12, 1908, G. B. Cashwell, “the apostle of Pentecost in the South,” who had been at Azusa Street, preached at the local church in Cleveland, Tennessee, at A. J. Tomlinson’s invitation. After Cashwell’s sermon Tomlinson fell to the floor and received the baptism of the Holy Spirit. He reported speaking in at least ten different languages while in the experience and saw in vision a worldwide harvest for the Church through missions. From then on the Church has remained in the classical Pentecostal tradition.</p>
        <p>Phenomenal early growth was interrupted in 1923 when the church divided over several issues that had accumulated over recent years, ranging from finances to the form of government needed to serve a rapidly growing fellowship. After the split both factions grew and continued building God’s kingdom, yet grief over the event lingered in both groups. In recent years spiritual reconciliation has been sought, and the two movements often cooperate and unite initiatives in ministry.</p>
        <p>The group led by A. J. Tomlinson gradually gained new strength after the 1923 rupture. In the 1930s the Church experienced a period of great revival and marked growth. Missionary work flourished as ministry spread into other nations.</p>
        <p>In the years since, the Church has continued to grow, seeking biblical truth and understanding in Scripture and the Holy Spirit’s guidance for its direction. From humble beginnings in the Appalachian Mountains, the Church has expanded to more than 130 countries worldwide with nearly a million members.</p>
        <p>The closing chapters of the Church’s history are not yet written. Our fervent desire is to fulfill our God-given role by carrying the gospel of Jesus Christ to a lost world and being ministers of reconciliation through which our heavenly Father will one day answer Jesus’ prayer that we all may be one in Him.</p>
      `,
    ...
    know_god_intro_p1: 'Have you ever wondered how to know God and experience the peace that comes from Him? This is an exciting, life-changing journey that can begin today. As you read, begin to open your heart to Him.',
    know_god_intro_p2: 'God wants to have a personal relationship with you because He loves you.',
    know_god_intro_p3: 'God Himself made the way for you to know Him. When you come to know Him, you can truly experience His peace and abundant life.',
    know_god_romans_5_1_quote: 'Therefore, since we have been justified through faith, we have peace with God through our Lord Jesus Christ.',
    know_god_romans_5_1_ref: 'Romans 5:1',
    know_god_john_10_10_quote: 'I have come that they may have life, and have it to the full.',
    know_god_john_10_10_ref: 'John 10:10',
    know_god_lead_in_powerful_verse: 'Another powerful Scripture tells us:',
    know_god_john_3_16_extended_quote: 'For God so loved the world that he gave his one and only Son (Jesus), that whoever believes in him shall not perish but have eternal life.',
    know_god_problem_sin_heading: 'The Problem — Sin',
    know_god_problem_sin_body: 'There is a vast chasm that separates every one of us from God and from each other. It is called sin. It is an inherited condition. All human beings sin—your own reasoning tells you this is true. The world is full of the consequences of sin, and we feel the separation it causes. Being restored to God does not happen automatically. You are separated from Him by sin.',
    know_god_answer_cross_heading: 'The Answer — The Cross',
    know_god_answer_cross_p1: 'God\'s love closes the distance between God and you.',
    know_god_answer_cross_p2: 'When Jesus Christ died on the cross and rose from the grave, He did so to pay the penalty for your sins.',
    know_god_1_peter_2_24_quote: 'He himself bore our sins in his body on the cross.',
    know_god_1_peter_2_24_ref: '1 Peter 2:24',
    know_god_what_must_i_do_heading: 'What must I do to cross the distance?',
    know_god_bridge_body: 'The good news is that God has already done everything necessary for us to know Him. He calls you to cross that bridge and enter His family! He had a plan long before He created the world, and that plan was fulfilled through the life, death, and resurrection of Jesus. Christ is the bridge! The separation between you and God is healed when you receive Him. He personally invites you to do that. The Bible says: "Yet to all who did receive him, to those who believed in his name, he gave the right to become children of God" (John 1:12). And there is more good news! God can help you mend other relationships too. He is a great bridge-builder!',
    know_god_starting_point_heading: 'The Starting Point',
    know_god_step_1: 'Admit that you need forgiveness. Be honest enough to say: "I have sinned and I need God\'s forgiveness."',
    know_god_step_2: 'Repent of your sins. That means turning around and walking in a new direction—in God\'s direction.',
    know_god_step_3: 'Believe and confess that Jesus Christ is Lord and that God raised Him from the dead.',
    know_god_step_4: 'Surrender control of your life to Jesus. Then He becomes your "Lord." You can do this with a sincere prayer.',
    know_god_rev_3_20_quote: 'Here I am! I stand at the door and knock. If anyone hears my voice and opens the door, I will come in.',
    know_god_rev_3_20_ref: 'Revelation 3:20',
    know_god_romans_10_13_quote: 'Everyone who calls on the name of the Lord will be saved.',
    know_god_romans_10_13_ref: 'Romans 10:13',
    know_god_sample_prayer_intro: 'Here is a sample prayer. Read it first, then say it aloud from your heart. Remember: it is not the prayer that saves you from sin, but your faith in Jesus.',
    know_god_sample_prayer_body: 'Dear Lord Jesus, I know that I am a sinner. I need forgiveness. I believe You died for my sins. I want to turn away from my sins. I invite You, right now, to come into my heart and make me a new person. I want to trust You and follow You as my Lord and Savior. In Jesus\' name, amen.',
    know_god_closing_contact: 'If you have prayed this prayer, write to us. We want to celebrate with you and help you grow as a believer in Jesus! You can contact the church here.',
    ...
    churches_found_one: '1 church found',
    churches_found_many: '{count} churches found',
